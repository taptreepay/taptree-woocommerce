...
class Paysafecard extends PaymentMethodAbstract implements PaymentMethodInterface
{
    protected function getProps(): array
    {
        return
            [
                'id' => 'paysafecard',
                'default_title' => __('Paysafecard', 'woocommerce'),
                'settings_description' => __('Accept payments via Paysafecard', 'woocommerce'),
                'default_description' => '',
                'has_fields' => false,
                'instructions' => true,
                'supports' => [
