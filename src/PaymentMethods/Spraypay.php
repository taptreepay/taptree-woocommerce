...
class Spraypay extends PaymentMethodAbstract implements PaymentMethodInterface
{
    protected function getProps(): array
    {
        return
            [
                'id' => 'spraypay',
                'default_title' => __('SprayPay', 'woocommerce'),
                'settings_description' => __('Accept payments via SprayPay', 'woocommerce'),
                'default_description' => '',
                'has_fields' => false,
                'instructions' => true,
                'supports' => [
