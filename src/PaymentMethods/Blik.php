...
class Blik extends PaymentMethodAbstract implements PaymentMethodInterface
{
    protected function getProps(): array
    {
        return
            [
                'id' => 'blik',
                'default_title' => __('Blik', 'woocommerce'),
                'settings_description' => __('Accept payments via Blik', 'woocommerce'),
                'default_description' => '',
                'has_fields' => false,
                'instructions' => true,
                'supports' => [
