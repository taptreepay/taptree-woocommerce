...
class Eps extends PaymentMethodAbstract implements PaymentMethodInterface
{
    protected function getProps(): array
    {
        return
            [
                'id' => 'eps',
                'default_title' => __('EPS', 'woocommerce'),
                'settings_description' => __('Accept payments via EPS', 'woocommerce'),
                'default_description' => '',
                'has_fields' => false,
                'instructions' => true,
                'supports' => [
